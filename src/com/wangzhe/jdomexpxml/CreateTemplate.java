package com.wangzhe.jdomexpxml;
...
public class CreateTemplate {
	...
	public static void main(String[] args) {
		String path = System.getProperty("user.dir")+"/bin/com/student.xml";
...
//						font.setFontHeight((short)12);
			...
			//生成Excle导入模板
			File tempFile = new File("e:/POI/"+templateName+".xls");
			tempFile.delete();
	...
	private static void setType(HSSFWorkbook workbook, HSSFCell cell, Element td) {
		...
		if("NUMERIC".equalsIgnoreCase(type)){
			...
			formatValue = StringUtils.isNotBlank(formatValue)?formatValue:"#.#00";
